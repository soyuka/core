...
//    private const ATTRIBUTE_V2_TO_V3 = '#[ApiResource] to #[Resource]';
    ...
    {
        $this
            ->setDescription('Change ApiResource annotation to attribute')
...
//            self::ATTRIBUTE_V2_TO_V3,
        ...
        switch ($choice) {
            case self::ANNOTATION_TO_ATTRIBUTE_V2;
                $command .= ' --config=src/Bridge/Rector/config/sets/upgrade-annotation-to-attribute-v2.php';
                break;
            case self::ANNOTATION_TO_ATTRIBUTE_V3;
                $command .= ' --config=src/Bridge/Rector/config/sets/upgrade-annotation-to-attribute-v3.php';
                break;
            case self::ANNOTATION_TO_ATTRIBUTE_V2_AND_V3;
                $command .= ' --config=src/Bridge/Rector/config/sets/upgrade-annotation-to-attribute-v2-and-v3.php';
                break;
