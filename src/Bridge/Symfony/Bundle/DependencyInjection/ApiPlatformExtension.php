...
final class ApiPlatformExtension extends Extension implements PrependExtensionInterface
{
    ...
    private function registerMetadataConfiguration(ContainerBuilder $container, array $config, XmlFileLoader $loader): void
    {
        ...
        $container->getDefinition('api_platform.metadata.resource_collection.extractor.xml')->replaceArgument(0, $xmlResources);
        ...
        if (class_exists(Yaml::class)) {
            ...
            $container->getDefinition('api_platform.metadata.resource_collection.extractor.yaml')->replaceArgument(0, $yamlResources);
        }
