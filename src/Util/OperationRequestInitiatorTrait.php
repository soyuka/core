...
trait OperationRequestInitiatorTrait
{
    ...
    private function initializeOperation(Request $request): ?Operation
    {
        ...
        $operationName = $request->attributes->get('_api_operation_name') ?? $request->attributes->get('_api_collection_operation_name') ?? $request->attributes->get('_api_item_operation_name');
