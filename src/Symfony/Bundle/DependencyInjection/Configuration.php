    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ...
            ->children()
                ...
                ->end()
                ->arrayNode('mapping')
                    ->setDeprecated('api-platform/symfony', '4.2', 'The "mapping" configuration is deprecated and will be removed in 5.0.')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('paths')
                ...
                ->arrayNode('resource_class_directories')
                    ->prototype('scalar')->end()
                    ->setDeprecated('api-platform/symfony', '4.2', 'The "resource_class_directories" configuration is deprecated, classes using #[ApiResource] attribute are autoconfigured by the dependency injection container. This configuration will be removed in 5.0.')
                ->end()
