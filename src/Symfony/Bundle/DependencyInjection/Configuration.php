...
final class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ...
            ->booleanNode('enable_link_security')->defaultTrue()->info('Enable security for Links (sub resources)')->end()->setDeprecated('api-platform/symfony', '4.2', 'Link security will always be enabled in API Platform 5.') // TODO: 5.x remove
