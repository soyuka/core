...
class IterableTypeTest extends TestCase
{
    ...
    public function testSerialize()
    {
        ...
        $this->{method_exists($this, 'expectExceptionMessageMatches') ? 'expectExceptionMessageMatches' : 'expectExceptionMessageRegExp'}('/`Iterable` cannot represent non iterable value: .+/');
