...
class DocumentationNormalizerTest extends TestCase
{
    ...
    public function testNormalizeInputOutputClass()
    {
        ...
        $dummyMetadata = new ResourceMetadataCollection('dummy', [
            (new ApiResource())
                ->withShortName('dummy')
                ...
                ->withOperations(new Operations([
                    ...
                    'post' => (new Post())->withShortName('dummy')->withInput(['class' => 'inputClass'])->withOutput(['class' => null]),
                    'get' => (new Get())->withShortName('dummy')->withInput(['class' => 'inputClass'])->withOutput(['class' => 'outputClass']),
