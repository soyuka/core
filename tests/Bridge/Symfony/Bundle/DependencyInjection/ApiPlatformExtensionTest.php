...
class ApiPlatformExtensionTest extends TestCase
{
    ...
    public function testResourcesToWatchWithUnsupportedMappingType()
    {
        ...
        $this->{method_exists($this, 'expectExceptionMessageMatches') ? 'expectExceptionMessageMatches' : 'expectExceptionMessageRegExp'}('/Unsupported mapping type in ".+", supported types are XML & YAML\\./');
