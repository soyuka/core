...
class ConfigurationTest extends TestCase
{
    ...
    public function testExceptionToStatusConfigWithInvalidHttpStatusCode($invalidHttpStatusCode)
    {
        ...
        $this->{method_exists($this, 'expectExceptionMessageMatches') ? 'expectExceptionMessageMatches' : 'expectExceptionMessageRegExp'}('/The HTTP status code ".+" is not valid\\./');
    ...
    public function testExceptionToStatusConfigWithInvalidHttpStatusCodeValue($invalidHttpStatusCodeValue)
    {
        ...
        $this->{method_exists($this, 'expectExceptionMessageMatches') ? 'expectExceptionMessageMatches' : 'expectExceptionMessageRegExp'}('/Invalid type for path "api_platform\\.exception_to_status\\.Exception". Expected "?int"?, but got "?.+"?\./');
    ...
    public function testSwaggerVersionConfig()
    {
        ...
        $this->expectException(InvalidConfigurationException::class);
        $this->{method_exists($this, 'expectExceptionMessageMatches') ? 'expectExceptionMessageMatches' : 'expectExceptionMessageRegExp'}('/Only the versions .+ are supported. Got .+./');
