...
class YamlExtractorTestCase extends ExtractorTestCase
{
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->{method_exists($this, 'expectExceptionMessageMatches') ? 'expectExceptionMessageMatches' : 'expectExceptionMessageRegExp'}('/Unable to parse in ".+\\/\\.\\.\\/\\.\\.\\/Fixtures\\/FileConfigurations\\/parse_exception.yml"/');
