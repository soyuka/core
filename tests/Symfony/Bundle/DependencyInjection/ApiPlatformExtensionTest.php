...
use ApiPlatform\Doctrine\Odm\Extension\FilterExtension as MongoDbOdmFilterExtension;
use ApiPlatform\Doctrine\Odm\Extension\OrderExtension as MongoDbOdmOrderExtension;
use ApiPlatform\Doctrine\Odm\Extension\PaginationExtension as MongoDbOdmPaginationExtension;
use ApiPlatform\Doctrine\Odm\Filter\AbstractFilter as DoctrineMongoDbOdmAbstractFilter;
use ApiPlatform\Doctrine\Odm\Filter\BooleanFilter as MongoDbOdmBooleanFilter;
use ApiPlatform\Doctrine\Odm\Filter\DateFilter as MongoDbOdmDateFilter;
use ApiPlatform\Doctrine\Odm\Filter\ExistsFilter as MongoDbOdmExistsFilter;
use ApiPlatform\Doctrine\Odm\Filter\NumericFilter as MongoDbOdmNumericFilter;
use ApiPlatform\Doctrine\Odm\Filter\OrderFilter as MongoDbOdmOrderFilter;
use ApiPlatform\Doctrine\Odm\Filter\RangeFilter as MongoDbOdmRangeFilter;
use ApiPlatform\Doctrine\Odm\Filter\SearchFilter as MongoDbOdmSearchFilter;
...
use ApiPlatform\Elasticsearch\Filter\OrderFilter as ElasticsearchOrderFilter;
...
class ApiPlatformExtensionTest extends TestCase
{
    ...
    public function testItLoadsMetadataConfigFileInAlphabeticalOrder()
    {
        ...
        $yamlExtractorDefinition->replaceArgument(0, Argument::that(static function ($paths): bool {
            ...
            $testsDirectory = \dirname(__DIR__, 3);
            ...
            self::assertSame(
                $normalizePaths([
                    ...
                    "{$testsDirectory}/Symfony/Bundle/DependencyInjection/Fixtures/resources/c.yaml",
                    "{$testsDirectory}/Symfony/Bundle/DependencyInjection/Fixtures/resources/c/a.yaml",
                ]),
    ...
    private function getPartialContainerBuilderProphecy($configuration = null)
    {
        ...
        $definitions = [
            ...
            'api_platform.symfony.listener.request.read',
        ...
        $aliases = [
            ...
            'api_platform.metadata.resource.metadata_collection_factory' => 'api_platform.metadata.resource.metadata_collection_factory.attributes',
    ...
    //TODO: to remove in 3.0
    private function addDeprecatedInterfacesToContainerBuilder($containerBuilderProphecy)
    {
