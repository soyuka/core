...
function _fd_fdstat_get(fd, pbuf) {
    try {
        ...
        (tempI64 = [
            rightsBase >>> 0,
            ((tempDouble = rightsBase), +Math.abs(tempDouble) >= 1 ? (tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0) : 0),
        ]),
