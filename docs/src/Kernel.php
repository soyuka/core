...
use PDG\Metadata\Resource\Factory\StaticResourceNameCollectionFactory;
...
class Kernel extends BaseKernel
{
    ...
    private function configureContainer(ContainerConfigurator $container, LoaderInterface $loader, ContainerBuilder $builder): void
    {
        ...
        foreach ($classes as $class) {
            ...
            if (0 !== strpos($ns, 'PDG') && 0 !== strpos($ns, 'App')) {
                continue;
            }
    ...
    public function getDeclaredClassesForNamespace(string $namespace): array
    {
